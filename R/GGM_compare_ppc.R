...
GGM_compare_ppc <- function(Y_g1, Y_g2, Y_g3 = NULL, Y_g4 = NULL,
  ...
  if(groups == 3){
    ...
    if(contrast == "Y_g1_vs_Y_g2"){
      ...
      pc1 <- cov2cor(unbiased_cov(Y_g2)) * -1
      pc1 <- pc1[upper.tri(pc1)]

      pc2 <- cov2cor(unbiased_cov(Y_g1)) * -1
      pc2 <- pc2[upper.tri(pc2)] * -1
    ...
    if(contrast == "Y_g1_vs_Y_g3"){
      ...
      pc1 <- cov2cor(unbiased_cov(Y_g3)) * -1
      pc1 <- pc1[upper.tri(pc1)]
  ...
  if(groups == 4){
    ...
    if(contrast == "Y_g1_vs_Y_g4"){
      ...
      pc1 <- cov2cor(unbiased_cov(Y_g4)) * -1
      pc1 <- pc1[upper.tri(pc1)]
    ...
    if(contrast == "Y_g3_vs_Y_g4"){
      ...
      pc2 <- cov2cor(unbiased_cov(Y_g3)) * -1
      pc2 <- pc2[upper.tri(pc2)] * -1
