...
mv_ordinal_albert <- function(Y, X, iter, delta, epsilon, K, start, progress, Y_missing, impute) {
    .Call(`_BGGM_mv_ordinal_albert`, Y, X, iter, delta, epsilon, K, start, progress, Y_missing, impute)
}

copula <- function(z0_start, levels, K, Sigma_start, iter, delta, epsilon, idx, progress, Y_missing, impute, Y) {
    .Call(`_BGGM_copula`, z0_start, levels, K, Sigma_start, iter, delta, epsilon, idx, progress, Y_missing, impute, Y)
}
