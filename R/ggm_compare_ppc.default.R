...
#'
#' @description Comparing any number of GGMs with the posterior predictive distribution. The method assume group equality, and the predictive check
...
#' For gaining (relative) evidence for the null hypothesis see X.
#'
#' @references
