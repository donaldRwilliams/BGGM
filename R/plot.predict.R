...
#' @export
#' @note x1 can be a \code{predict} object that asseses predictive accuracy on in- or out-of-sample (\code{test_data}) data. x2 can be used to
#' visiually compare in- and out-of sample predictive accuracy. This is accomplished by providing the respective \code{predict} objects to
