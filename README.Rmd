...
* [Estimation](https://github.com/donaldRwilliams/BGGM#estimation)
    ...
    + [Prediction](https://github.com/donaldRwilliams/BGGM#prediction)
        ...
        - [Bayesian $R^2$](https://github.com/donaldRwilliams/BGGM#bayesian-r2)
...
For Bayesian hypothesis testing in particular, it is important to *fully* understand the prior distribution $\mathcal{H}_u$. This is because caputres the predicted effect size, and it is used to compute the Bayes factor. This stands in contrast to the above estimation based methods, where $E$ is determined with respect to the posterior distribution. To this end, \pkg{BGGM} includes functions to visualize the prior distribution--i.e.,
