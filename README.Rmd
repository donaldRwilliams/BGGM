...
In this case, because each group was assumed to have equal edges, $\mathcal{H}_2$ was supported by the data. We again emphasize that edges can be tested in any size network (assuming that $n > p$)
