...
The posterior hypothesis probability of `0.895` which provides some evidence for the order 
constraint. The Bayes factor matrix divides the posterior probabilities, which provide a measure
of relative support for which hypothesis best predicted the data. 
