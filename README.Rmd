...
The returned object can also be plotted, which allows for visualzing the posterior uncertainty interval for each relation. This summary can the be plotted. An example is provided below in [Posterior uncertainty intervals](#posterior-uncertatiny). 
