...
Note that the R package mgm also provides $R^2$, but only provides point estimate. It would be possible to apply the bootstrap. However, then $R^2$ would not be conditional on this fitted model and posterior distributions but instead would capture sampling variability.
