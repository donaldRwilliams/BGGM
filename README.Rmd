...
The returned object can also be plotted, which allows for visualzing the posterior uncertainty intervals 
for each relation. An example is provided below in [Posterior uncertainty intervals](#posterior-uncertatiny). 
