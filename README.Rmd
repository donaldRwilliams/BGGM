...
1.  Bayesian estimation with the novel matrix-F prior distribution [@Mulder2018]
    ...
    + Estimation (#Estimation) [@Williams2019]

2. Bayesian hypothesis testing with the matrix-F prior distribution [@Mulder2018].

    + [Exploratory hypothesis testing](#Exploratory Hypothesis Testing) [@Williams2019_bf].
  
    + [Confirmatory hypothesis testing](#Exploratory Hypothesis Testing) [@Williams2019_bf].
