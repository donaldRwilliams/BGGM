...
information, such as edge weigths, is considered). Note that `FUN` only requires that the user defined function accepts two datasets as the input and returns a single number (the chosen test-statistic).
