...
## Example
###  Hypothesis Testing
These methods allow for gaining evidence for both conditional depedence ($\rho_{ij} \neq 0$) and independence ($\rho_{ij} = 0$). Note that GGMs are often thought to characterize conditional independece structures, but evidence for the null hypothesis of no effect is not typically assessed.
