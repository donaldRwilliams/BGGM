...
Note that the R package mgm also provides $R^2$, but only a point estimate. It would be possible to apply the boostrap, but then $R^2$ would not conditional on this fitted model but instead would capture variability in the selected model. 
