...
dependenet effects are larger for female than males (note the `&`), with the additional contraint to positive values, whereas the second hypothesis is a "null" model.
