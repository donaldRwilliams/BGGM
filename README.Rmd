...
knitr::kable(round(cors$R_mean, 3), caption = "Tetrachoric",
             col.names = c("1", "2", "3","4","5", "6"), 
             row.names = TRUE)
```

Note that the object `cors` also includes the sampled correlation matrices (in this case 250) in an array.
