 ...
 **BGGM is now maintained at <https://github.com/rast-lab/BGGM>.**  
 ...
 This original repository (<https://github.com/donaldRwilliams/BGGM>) is no longer actively developed.
 All new issues, pull requests, and development take place at:
...
To install the latest release version (`r tryCatch(available.packages()["BGGM", "Version"],error = function(e) as.character(utils::packageVersion("BGGM")))`) from CRAN use
