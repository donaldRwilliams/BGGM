...
Here the prediction was supported. This powerful approach can be used to test, essentiallly, any hypothesized order restriction in relation to zero (directional) or, as in the first example, specific edges.
<!-- (1--2,1--3,1--4)<0<(1--6) -->
# Comparing GGMs
