...
#>  2--3    0.2868   0.018  0.251  0.322
#>  1--4   -0.0068   0.020 -0.045  0.032
#>  2--4    0.1647   0.019  0.128  0.201
#>  3--4    0.1775   0.018  0.140  0.213
#>  1--5   -0.0087   0.020 -0.047  0.031
#>  2--5    0.1556   0.019  0.119  0.192
...
#>   1--5 - 1--3      0.09  0.0317 0.3756 0.6244
#>   1--2 - 1--6   -0.2971  0.0267      1      0
#>   1--4 - 1--7   -0.0868  0.0297 0.3326 0.6674
#>  1--5 - 1--10    0.0097  0.0263      0      1
#> ---
```
...
#>     2    -0.279   0.022 -0.320 -0.238
#>     3    -0.123   0.023 -0.172 -0.078
#>     4    -0.015   0.020 -0.053  0.025
#>     5    -0.018   0.021 -0.059  0.022
#>     6     0.056   0.020  0.013  0.094
#>     7     0.081   0.021  0.039  0.122
#>     8     0.045   0.021  0.002  0.085
#>     9     0.142   0.022  0.099  0.184
#>    10    -0.028   0.022 -0.071  0.016
#> ---
```
...
#> 
#>  node post_mean    post_sd      2.5%     97.5%
#>     1 0.1694548 0.06611656 0.0479670 0.3000111
#>     2 0.2887826 0.06617436 0.1498562 0.4107866
#> ---
```
...
#>  
#>            1          2          3         4         5
#> 1  0.0000000 -0.2399710 -0.1076782 0.0000000 0.0000000
#> 2 -0.2399710  0.0000000  0.2863206 0.1651034 0.1562068
#> 3 -0.1076782  0.2863206  0.0000000 0.1776868 0.3586841
#> 4  0.0000000  0.1651034  0.1776868 0.0000000 0.1213113
#> 5  0.0000000  0.1562068  0.3586841 0.1213113 0.0000000
#> --- 
#>  
#> Adjancency (non-zero) 
#>  
...
#>  1--2   -0.2400   0.018  77.5
#>  1--3   -0.1077   0.019  12.0
#>  2--3    0.2863   0.018 113.6
#>  1--4   -0.0075   0.019  -3.5
#>  2--4    0.1651   0.019  34.0
#>  3--4    0.1777   0.019  39.7
#>  1--5   -0.0089   0.019  -3.5
#>  2--5    0.1562   0.019  28.9
#>  3--5    0.3587   0.017 190.5
#>  4--5    0.1213   0.019  16.7
#> --- 
...
#>  1--2 -0.24422567 0.01861535   0.000   0.000   1.000
#>  1--3 -0.10595585 0.01937885   0.000   0.000   1.000
#>  2--3  0.28616683 0.01790415   0.000   1.000   0.000
#>  1--4 -0.01448496 0.01944426   0.997   0.001   0.002
#>  2--4  0.16102456 0.01877527   0.000   1.000   0.000
#> ---
```
...
#>   1--5 - 1--3  0.089774861 0.03198375   0.147   0.851   0.002
#>   1--2 - 1--6 -0.296643535 0.02661932   0.000   0.000   1.000
#>   1--4 - 1--7 -0.086918941 0.02953621   0.085   0.002   0.914
#>  1--5 - 1--10  0.009506681 0.02653020   0.998   0.001   0.001
#>   1--2 - 1--9 -0.367695372 0.02608455   0.000   0.000   1.000
#> ---
```
...
#>  Y_g1 vs Y_g2 0.2760634  0.3428
#>  Y_g1 vs Y_g3 0.2628349  0.4794
#>  Y_g2 vs Y_g3 0.2356133  0.7714
#> --- 
#> note: 
...
#> Picking joint bandwidth of 0.00597
```

<img src="man/figures/README-unnamed-chunk-37-1.png" width="325 %" style="display: block; margin: auto;" />
