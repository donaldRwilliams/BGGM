...
#>  1--2   -0.2402   0.018 -0.275 -0.205
#>  1--3   -0.1073   0.019 -0.145 -0.069
#>  2--3    0.2869   0.018  0.252  0.321
#>  1--4   -0.0073   0.019 -0.044  0.029
#>  2--4    0.1646   0.019  0.128  0.202
#>  3--4    0.1771   0.018  0.141  0.213
#>  1--5   -0.0092   0.019 -0.047  0.028
#>  2--5    0.1556   0.019  0.118  0.192
#>  3--5    0.3588   0.017  0.327  0.392
#>  4--5    0.1218   0.019  0.085  0.159
#> ---
```
...
#>  1--3    -0.106   0.019 0.6224 0.3776
#>  2--3     0.287   0.018 1.0000 0.0000
#>  1--4    -0.014   0.020 0.0002 0.9998
#>  2--4     0.160   0.019 0.9998 0.0002
#>  3--4     0.160   0.019 0.9988 0.0012
#>  1--5    -0.016   0.019 0.0000 1.0000
#>  2--5     0.145   0.019 0.9886 0.0114
#>  3--5     0.354   0.017 1.0000 0.0000
#>  4--5     0.115   0.019 0.7712 0.2288
#> ---
```
...
#>   1--5 - 1--3    0.0901  0.0318 0.3696 0.6304
#>   1--2 - 1--6   -0.2972  0.0266      1      0
#>   1--4 - 1--7   -0.0869  0.0299  0.334  0.666
#>  1--5 - 1--10    0.0094  0.0267  6e-04 0.9994
#> ---
```
...
#>     2    -0.279   0.022 -0.320 -0.236
#>     3    -0.124   0.023 -0.168 -0.079
#>     4    -0.016   0.021 -0.056  0.027
#>     5    -0.017   0.022 -0.060  0.026
#>     6     0.057   0.021  0.015  0.098
#>     7     0.081   0.021  0.041  0.125
#>     8     0.046   0.020  0.005  0.084
#>     9     0.142   0.022  0.099  0.184
#>    10    -0.027   0.021 -0.068  0.013
#> ---
```
...
#> 
#>  node post_mean    post_sd       2.5%     97.5%
#>     1 0.1685772 0.06672124 0.04762696 0.3059684
#>     2 0.2860162 0.06815148 0.13883497 0.4091552
#> ---
```
...
#>  
#>            1          2          3         4         5
#> 1  0.0000000 -0.2404117 -0.1069968 0.0000000 0.0000000
#> 2 -0.2404117  0.0000000  0.2861802 0.1642443 0.1559721
#> 3 -0.1069968  0.2861802  0.0000000 0.1780549 0.3589053
#> 4  0.0000000  0.1642443  0.1780549 0.0000000 0.1214655
#> 5  0.0000000  0.1559721  0.3589053 0.1214655 0.0000000
#> --- 
#>  
#> Adjancency (non-zero) 
#>  
...
#>  1--2   -0.2404   0.018  77.7
#>  1--3   -0.1070   0.019  11.7
#>  2--3    0.2862   0.018 114.8
#>  1--4   -0.0076   0.019  -3.5
#>  2--4    0.1642   0.019  33.8
#>  3--4    0.1781   0.019  40.3
#>  1--5   -0.0094   0.019  -3.4
#>  2--5    0.1560   0.019  30.3
#>  3--5    0.3589   0.017 192.6
...
#>  1--2 -0.2447282 0.01829889   0.000   0.000   1.000
#>  1--3 -0.1054275 0.01888758   0.000   0.000   1.000
#>  2--3  0.2861627 0.01769092   0.000   1.000   0.000
#>  1--4 -0.0144213 0.01954015   0.997   0.001   0.002
#>  2--4  0.1607980 0.01906624   0.000   1.000   0.000
#> ---
```
...
#>   1--5 - 1--3  0.089624525 0.03151905   0.128   0.870   0.002
#>   1--2 - 1--6 -0.296542784 0.02674864   0.000   0.000   1.000
#>   1--4 - 1--7 -0.087324629 0.02935928   0.073   0.001   0.925
#>  1--5 - 1--10  0.009619424 0.02687353   0.998   0.001   0.001
#>   1--2 - 1--9 -0.367791041 0.02580025   0.000   0.000   1.000
#> ---
```
...
#>  Y_g1 vs Y_g2 0.2668439  0.4278
#>  Y_g1 vs Y_g3 0.2246606  0.8614
#>  Y_g2 vs Y_g3 0.2754904  0.3496
#> --- 
#> note: 
