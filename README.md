...
#>  2--3    0.2866   0.018  0.252  0.321
#>  1--4   -0.0076   0.019 -0.044  0.031
#>  2--4    0.1642   0.018  0.128  0.201
#>  3--4    0.1782   0.019  0.140  0.215
#>  1--5   -0.0089   0.019 -0.047  0.028
#>  2--5    0.1563   0.019  0.119  0.192
#>  3--5    0.3587   0.017  0.326  0.391
#>  4--5    0.1218   0.019  0.085  0.160
#> ---
```
...
#>   1--5 - 1--3    0.0896  0.0315 0.3724 0.6276
#>   1--2 - 1--6   -0.2978   0.027      1      0
#>   1--4 - 1--7   -0.0868  0.0294 0.3266 0.6734
#>  1--5 - 1--10    0.0098  0.0269      0      1
#> ---
```
...
#>     2    -0.278   0.020 -0.320 -0.240
#>     3    -0.124   0.023 -0.168 -0.079
#>     4    -0.015   0.021 -0.056  0.026
#>     5    -0.018   0.021 -0.059  0.026
#>     6     0.057   0.021  0.013  0.097
#>     7     0.080   0.022  0.036  0.121
#>     8     0.045   0.021  0.004  0.085
#>     9     0.140   0.022  0.097  0.184
#>    10    -0.027   0.022 -0.069  0.016
#> ---
```
...
#> 
#>  node post_mean    post_sd       2.5%     97.5%
#>     1 0.1666384 0.06444184 0.05283016 0.2988335
#>     2 0.2866785 0.06762393 0.15632685 0.4086907
#> ---
```
...
#>  
#>            1          2          3         4         5
#> 1  0.0000000 -0.2402800 -0.1073595 0.0000000 0.0000000
#> 2 -0.2402800  0.0000000  0.2862685 0.1646735 0.1563413
#> 3 -0.1073595  0.2862685  0.0000000 0.1778475 0.3584314
#> 4  0.0000000  0.1646735  0.1778475 0.0000000 0.1213064
#> 5  0.0000000  0.1563413  0.3584314 0.1213064 0.0000000
#> --- 
#>  
#> Adjancency (non-zero) 
#>  
...
#>  1--2   -0.2403   0.018  76.9
#>  1--3   -0.1074   0.018  13.2
#>  2--3    0.2863   0.018 112.5
#>  1--4   -0.0076   0.019  -3.5
#>  2--4    0.1647   0.019  34.3
#>  3--4    0.1778   0.019  39.1
#>  1--5   -0.0092   0.019  -3.4
#>  2--5    0.1563   0.019  29.9
#>  3--5    0.3584   0.017 192.0
#>  4--5    0.1213   0.019  16.8
#> --- 
...
#>  1--2 -0.24423011 0.01822249   0.000   0.000   1.000
#>  1--3 -0.10577842 0.01883116   0.000   0.000   1.000
#>  2--3  0.28613307 0.01801879   0.000   1.000   0.000
#>  1--4 -0.01384257 0.01974105   0.997   0.001   0.002
#>  2--4  0.16130525 0.01885357   0.000   1.000   0.000
#> ---
```
...
#>   1--5 - 1--3  0.089681229 0.03200030   0.159   0.839   0.002
#>   1--2 - 1--6 -0.296494292 0.02666851   0.000   0.000   1.000
#>   1--4 - 1--7 -0.087232017 0.02942491   0.077   0.001   0.922
#>  1--5 - 1--10  0.009877072 0.02669166   0.998   0.001   0.001
#>   1--2 - 1--9 -0.368041515 0.02654544   0.000   0.000   1.000
#> ---
```
...
For example, suppose we expected (predicted) the following: ℋ<sub>1</sub> : *ρ*<sub>1, 2</sub> &gt; *ρ*<sub>1, 3</sub> &gt; *ρ*<sub>1, 4</sub> &gt; *ρ*<sub>1, 5</sub> vs. ℋ<sub>*c*</sub>: Not ℋ<sub>1</sub>
...
As indicated by the posterior probabilities, the hypothesis was not supported. \# Comparing GGMs
