...
#>  1--3   -0.1076   0.019 -0.146 -0.071
#>  2--3    0.2861   0.018  0.252  0.321
#>  1--4   -0.0078   0.019 -0.047  0.029
#>  2--4    0.1645   0.019  0.128  0.202
#>  3--4    0.1777   0.019  0.142  0.215
#>  1--5   -0.0087   0.020 -0.046  0.030
...
#>   1--5 - 1--3    0.0899  0.0316  0.369  0.631
#>   1--2 - 1--6   -0.2963  0.0265      1      0
#>   1--4 - 1--7   -0.0875  0.0292 0.3334 0.6666
#>  1--5 - 1--10    0.0102  0.0265  4e-04 0.9996
#> ---
```
...
#>     2    -0.278   0.022 -0.319 -0.238
#>     3    -0.124   0.022 -0.167 -0.078
#>     4    -0.015   0.020 -0.053  0.022
#>     5    -0.017   0.021 -0.058  0.022
#>     6     0.056   0.021  0.017  0.098
#>     7     0.081   0.022  0.040  0.122
#>     8     0.043   0.020  0.003  0.082
#>     9     0.141   0.022  0.098  0.186
#>    10    -0.028   0.022 -0.071  0.017
#> ---
```
...
#> 
#>  node post_mean    post_sd       2.5%     97.5%
#>     1 0.1720818 0.06818538 0.04534859 0.3127137
#>     2 0.2881138 0.06748081 0.15290812 0.4076806
#> ---
```
...
#>  
#>            1          2          3         4         5
#> 1  0.0000000 -0.2403316 -0.1074291 0.0000000 0.0000000
#> 2 -0.2403316  0.0000000  0.2866706 0.1649047 0.1554617
#> 3 -0.1074291  0.2866706  0.0000000 0.1778405 0.3586977
#> 4  0.0000000  0.1649047  0.1778405 0.0000000 0.1217861
#> 5  0.0000000  0.1554617  0.3586977 0.1217861 0.0000000
#> --- 
#>  
#> Adjancency (non-zero) 
#>  
...
#>  2--3    0.2867   0.018 111.4
#>  1--4   -0.0072   0.019  -3.5
#>  2--4    0.1649   0.019  33.2
#>  3--4    0.1778   0.019  38.5
#>  1--5   -0.0095   0.019  -3.5
#>  2--5    0.1555   0.019  29.9
#>  3--5    0.3587   0.017 188.5
#>  4--5    0.1218   0.019  16.3
#> --- 
...
#>  1--2 -0.24379187 0.01820858   0.000   0.000   1.000
#>  1--3 -0.10591426 0.01919159   0.000   0.000   1.000
#>  2--3  0.28661469 0.01795796   0.000   1.000   0.000
#>  1--4 -0.01462808 0.01938924   0.997   0.001   0.002
#>  2--4  0.16122482 0.01909137   0.000   1.000   0.000
#> ---
```
...
#>   1--5 - 1--3  0.09002488 0.03223705   0.161   0.837   0.002
#>   1--2 - 1--6 -0.29646563 0.02679531   0.000   0.000   1.000
#>   1--4 - 1--7 -0.08767106 0.02919989   0.064   0.001   0.935
#>  1--5 - 1--10  0.01018712 0.02713566   0.998   0.001   0.001
#>   1--2 - 1--9 -0.36837051 0.02604850   0.000   0.000   1.000
#> ---
```
...
#>  Y_g1 vs Y_g2 0.2292156  0.8248
#>  Y_g1 vs Y_g3 0.2684224  0.4290
#>  Y_g2 vs Y_g3 0.2878582  0.2408
#> --- 
#> note: 
...
# predictive check
ggm_ppc <- ggm_compare_ppc(Y1, Y2, type = "nodewise", iter = 5000)
# summary
summary(ggm_ppc)
#> BGGM: Bayesian Gaussian Graphical Models 
#> --- 
