...
# Generated by GNU Autoconf 2.69 for mfbvar 0.4.0.
#
#
...
subdirs=
  ...
  PACKAGE_NAME='mfbvar'
PACKAGE_TARNAME='mfbvar'
PACKAGE_VERSION='0.4.0'
PACKAGE_STRING='mfbvar 0.4.0'
PACKAGE_BUGREPORT=''
PACKAGE_URL=''
...
cat <<_ACEOF
\`configure' configures mfbvar 0.4.0 to adapt to many kinds of systems.
...
--docdir=DIR            documentation root [DATAROOTDIR/doc/mfbvar]
...
short | recursive ) echo "Configuration of mfbvar 0.4.0:";;
esac
cat <<\_ACEOF
...
It was created by mfbvar $as_me 0.4.0, which was
...
ac_log="
  This file was extended by mfbvar $as_me 0.4.0, which was
  generated by GNU Autoconf 2.69.  Invocation command line was
