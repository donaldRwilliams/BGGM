...
There are automatic checks for **BGGM**. This can be seen in the right panel "build". That badge is linked
to the build history for **BGGM**. However, that only checks for Linux and **BGGM** is built on Windows. 
The most common installation errors occur on osx (Mac). An evolving guide to address these
