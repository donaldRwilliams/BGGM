...
# Two Groups
This next example is for two groups. The data are called `bfi` and they are in the **BGGM** package. I compare a sum of relations two relations for questions measuring agreeableness in males and females. The relations tested are as follows
...
```
## Sanity Check
For a kind of sanity check, here is the sum for the female group obtained from the point estimates
